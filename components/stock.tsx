...
export default function Stock({ symbol, price, delta }: TStock) {
  const [priceAtDate, setPriceAtDate] = useState({
    date: "",
  ...
  return (
    <div className="p-4 text-green-400 border rounded-xl bg-zinc-950">
      ...
      <div className="mt-1 text-xs text text-zinc-500">
        Closed: {format(date.setDate(date.getDate() - 1), "dd LLL yy")}
      </div>
      ...
      <div
        ...
        onPointerMove={event => {
          if (chartRef.current) {
            ...
            setPriceAtDate({
              date: format(xToDate(clientX - left), "dd LLL yy"),
      ...
      >
        {priceAtDate.x > 0 ? (
          <div
            ...
            style={{
              left: priceAtDate.x - 124 / 2,
              top: 30,
            }}
          >
            <div className="text-xs tabular-nums">${priceAtDate.value}</div>
